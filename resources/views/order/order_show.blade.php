            ...
            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                <li class="nav-item">
                    <button type="button" 
                            ...
                            data-bs-target="#navs-pills-justified-order" 
                            aria-controls="navs-pills-justified-order" 
                            aria-selected="true"
                    >
                ...
                <li class="nav-item">
                    <button type="button" 
                            ...
                            role="tab" 
                            data-bs-toggle="tab" 
                            data-bs-target="#navs-pills-justified-client" 
                            aria-controls="navs-pills-justified-client" 
                            aria-selected="false"
                    >
            ...
            <div class="tab-content">
                ...
                >
                    ...
                    <dl class="row mt-2">
                        ...
                        <dd class="col-sm-9"> {{ $order->client->full_name }} </dd>
                ...
                <div class="tab-pane fade" 
                    id="navs-pills-justified-client" 
                    role="tabpanel"
                >
