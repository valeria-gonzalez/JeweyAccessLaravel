...
<html lang="en" class="light-style layout-menu-fixed layout-wide" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('/sneat/assets/') }}" data-template="vertical-menu-template-free">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="layout-demo-wrapper">
                            <div class="layout-demo-placeholder">
                                <img src="{{ asset('/sneat/assets/img/layouts/layout-fluid-light.png') }}" class="img-fluid" alt="Layout fluid" data-app-light-img="layouts/layout-fluid-light.png" data-app-dark-img="layouts/layout-fluid-dark.png" />
                            </div>
